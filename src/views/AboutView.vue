    ...
    <div>
      ...
      <div class="flex gap-4 items-center flex-wrap justify-center py-4">
        ...
        <h2 class="max-w-96">
          ...
          producto que creo lleva consigo un pedacito de mí: mi atención al
          detalle, mi amor por el arte de tejer y mi deseo de compartir calidez
          y alegría en el mundo. Te invito a explorar mi colección y descubrir
          la belleza y versatilidad del crochet. Ya sea que busques el regalo
          perfecto o quieras mimarte con algo especial, estoy aquí para ayudarte
      ...
      <div class="flex gap-4 items-center flex-wrap justify-center py-4">
        <h2 class="max-w-96">
          ...
          pequeño universo de lana y crochet. ¡Gracias por ser parte de esta
          hermosa aventura tejida con amor!
        </h2>
        <img src="../assets/about3.png" alt="logo" class="" />
      </div>
    </div>
  </div>
</template>
